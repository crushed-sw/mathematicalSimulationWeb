...
const maskCurveConfig = reactive({
    data: `M ${props.points[0]} ${props.points[1]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[4]} ${props.points[5]},
           M ${props.points[4]} ${props.points[5]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[0]} ${props.points[1]}`,
    stroke: props.mask,
...
function updateMaskCurveConfig() {
    maskCurveConfig.data = `M ${props.points[0]} ${props.points[1]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[4]} ${props.points[5]},
                            M ${props.points[4]} ${props.points[5]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[0]} ${props.points[1]}`;
...
function updateCurveConfig() {
    curveConfig.data = `M ${props.points[0]} ${props.points[1]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[4]} ${props.points[5]},
                        M ${props.points[4]} ${props.points[5]}, Q ${props.points[2]} ${props.points[3]}, ${props.points[0]} ${props.points[1]}`;
...
function enter(event: any) {
    if(props.index > 0) {
        ...
        store.global.hover.type = Types.QuadraticBezier;
