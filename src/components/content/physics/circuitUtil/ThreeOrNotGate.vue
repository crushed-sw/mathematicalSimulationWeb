...
function out() {
    ...
    return Number(!(!!props.in[0] || !!props.in[1] || !!props.in[2]));
}
...
const dataValue = "M-45,36.212 A51.212,51.212,45,0,0,-45,-36.212 M-45,36.212 Q10,40,30,0 M-45,-36.212 Q10,-40,30,0";
...
const backValue = "M-45,36.212 A51.212,51.212,45,0,0,-45,-36.212 Q10,-40,30,0 Q10,40,-45,36.212"
