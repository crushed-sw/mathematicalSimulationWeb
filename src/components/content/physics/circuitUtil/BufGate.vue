...
const inValue = "M-40,0 L-15,0";
const outValue = "M20,0 L40,0";
const backValue = "M-15,-20 L20,0 L-15,20 L-15,-20"

function enter(event: any) {
    if(props.isPreview) {return;}
    isPointVisible.value = true;
    store.annotation.value = `in: &nbsp${props.in[0]}<br />out: ${props.in[0]}`;
