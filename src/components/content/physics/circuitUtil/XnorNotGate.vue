...
function out() {
    ...
    return Number((!!props.in[0] && !!props.in[1]) || (!props.in[0] && !props.in[1]));
}
...
const dataValue = "M-45,36.212 A51.212,51.212,45,0,0,-45,-36.212 M-35,36.212 A51.212,51.212,45,0,0,-35,-36.212 M-50,20 L-35,20 M-50,-20 L-35,-20 M-35,36.212 Q10,40,30,0 M-35,-36.212 Q10,-40,30,0";
